...
class OnboardingViewModel: ObservableObject {
    ...
    func loadMockPostsIfNeeded() {
        ...
        employerFeedPosts = [
            ...
            EmployerPostCardModel(
                postID: UUID().uuidString,
                profileImage: UIImage(named: "5em")!,
